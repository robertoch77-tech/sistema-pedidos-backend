              ...
              <tbody>
                {[1,2,3,4,5].map(i => (
                  <tr key={i} style={{ backgroundColor: i % 2 === 0 ? '#F7FAFC' : '#fff' }}>
                    <td style={{ padding: '8px 0', color: GRAY, fontSize: '12px' }}>{1000 + i}</td>
                    <td style={{ padding: '8px', color: TEXT, fontWeight: 500 }}>—</td>
                    <td style={{ padding: '8px', color: GREEN, fontWeight: 600 }}>$0</td>
                    <td style={{ padding: '8px' }}><span style={{ fontSize: '11px', color: GRAY, backgroundColor: '#EDF2F7', borderRadius: '12px', padding: '2px 8px' }}>Sin datos</span></td>
                  </tr>
                ))}
              </tbody>
            </table>
